            ...
            <div className="row d-flex align-items-center justify-content-center py-2">
              <div className="row px-0 d-flex align-items-center">
                <div className="col-md-8 align-items-center desktop-devices">
                  ...
                  <div className="h6 text-white text-size">
                    {/* Je prends rendez-vous avec un conseiller */}I make an
                    online simulation
                  </div>
                </div>
                <div className="col-md-4 mb-2 justify-content-end desktop-devices">
                  <Link
                    ...
                    className="btn btn-sm p-2 btn-size"
                  >
                    Simulation
                  </Link>
                </div>
                ...
                <div className="col-10 mb-4 flex-column mobile-devices">
                  ...
                  <Link
                    to="/VehicleSimulation"
                    className="btn btn-sm p-0 btn-size"
                  >
                    Simulation
                  </Link>
                </div>
              ...
              <div className="row px-0 d-flex align-items-center">
                ...
                <div className="col-10 mb-4 flex-column mobile-devices">
                  ...
                  <Link
                    to="/VehicleSimulation"
                    className="btn btn-orange p-0 btn-size"
                  >
                    Rendez-vous
                  </Link>
                </div>
              ...
              <div className="row px-0 d-flex align-items-center">
                ...
                <div className="col-10 mb-4 flex-column mobile-devices">
                  <div className="h6 text-white text-size">
                    {/* Je prends rendez-vous avec un conseiller */}I would like
                    to receive more information
                  </div>
                  <Link
                    to="/VehicleSimulation"
                    className="btn iconSize btn-blue p-0 btn-size"
                  >
                    Contact
                  </Link>
                </div>
...
=======
  return <div>Hello Dashboard! Nilesh commit test</div>;
>>>>>>> fe9d8bf44fa535c86e3c5ab6640a42cc4f9ca386
};
